...
var kemo=function(a){a.core=a.core||{};a.core.ready=function(a){"loading"!=document.readyState?a():document.addEventListener("DOMContentLoaded",a)};return a}(kemo||{}),kemo=function(a){a.client=a.client||{};a.client.comm=a.client.comm||{};a.client.comm.config={auditEnabled:!0,checkTimeout:15E3,onErrorReconnect:1E4};var d=function(c,b){var a="";try{a=sjcl.decrypt("clientenc"+c+"salt",b)}catch(d){console.error("Unexpected error when decrypting received message.",d)}return a},h=function(c){var b="",
b="http:"===location.protocol?"8080"===location.port?"ws://"+location.host:"ws://"+location.hostname+":8000":"wss://"+location.hostname+":8443";return b+"/messaging/"+encodeURIComponent(sjcl.codec.base64.fromBits(sjcl.hash.sha256.hash("littlebitof"+c+"salt")))},c=function(c,b,d){if(a.client.comm.config.auditEnabled&&console&&console.log){var e="null";b&&b.ws&&(e="state: ",e=b.ws.readyState===WebSocket.CONNECTING?e+"CONNECTING":b.ws.readyState===WebSocket.OPEN?e+"OPEN":b.ws.readyState===WebSocket.CLOSING?
e+"CLOSING":b.ws.readyState===WebSocket.CLOSED?e+"CLOSED":e+"UNKNOWN");b=void 0!==d?" "+d:"";console.log((new Date).toUTCString()+" "+(void 0!==c?c:"UNKNOWN")+" "+e+b)}};a.client.comm.Messaging=function(g){var b=this;b.key=g;b.ws=null;b.connect=function(f,e){c("CONNECT",b);try{b.key=f,!b.ws||b.ws.readyState!==WebSocket.OPEN&&b.ws.readyState!==WebSocket.CONNECTING||(c("CONNECT_CLOSING",b),b.ws.onmessage=function(){},b.ws.close()),b.ws=new WebSocket(h(f)),c("CONNECT_NEWSOCKET",b),b.ws.onopen=function(){c("CONNECT_NEWSOCKET_OPEN",
b);b.ws.onmessage=function(c){b.onmessage(d(b.key,c.data))};e&&e()},b.ws.onerror=function(){c("ONERROR",b);setTimeout(b.reconnect,a.client.comm.config.onErrorReconnect)}}catch(g){c("UNEXPECTEDERROR",b,g)}};b.onmessage=function(b){};b.send=function(a,d){b.ws.readyState!==WebSocket.OPEN||b.key!==a?(c("SEND_NEEDCONNECT",b),b.connect(a,function(){b.ws.send(sjcl.encrypt("clientenc"+a+"salt",d))})):(c("SEND",b),b.ws.send(sjcl.encrypt("clientenc"+a+"salt",d)))};b.connectionCheck=function(){c("CHECK",b);
b.ws&&b.ws.readyState!==WebSocket.CONNECTING&&b.ws.readyState!==WebSocket.OPEN&&b.reconnect();setTimeout(b.connectionCheck,a.client.comm.config.checkTimeout)};b.reconnect=function(){c("RECONNECT",b);b.ws?b.ws.readyState===WebSocket.CONNECTING||b.ws.readyState===WebSocket.OPEN?(c("RECONNECT_OPEN/CONNECTING",b),b.ws.onmessage=function(){},b.ws.close(),b.ws.onclose=function(){b.connect(b.key,null)}):b.ws.readyState===WebSocket.CLOSING?(c("RECONNECT_CLOSING",b),b.ws.onmessage=function(){},b.ws.onclose=
function(){b.connect(b.key,null)}):b.ws.readyState===WebSocket.CLOSED&&(c("RECONNECT_CLOSED",b),b.connect(b.key,null)):(c("RECONNECT_NEWCONNECTION",b),b.connect(b.key,null))};return b};return a}(kemo||{}),kemo=function(a){a.client=a.client||{};a.client.view=a.client.view||{};a.client.view.util=a.client.view.util||{};var d=a.client.view.util;a.client.view.mountKemoChat=function(a,c){return riot.mount(a,{page:c})[0]};riot.tag2("kemo-chat",'\t\t\t\x3cdiv\x3e\t\t\t\t\x3cdiv class\x3d"row"\x3e\t\t\t\t\t\x3cinput type\x3d"password" kemo-type\x3d"key" value\x3d{key} onchange\x3d"{onKeyChanged}" onblur\x3d"{onKeyChanged}" class\x3d"key-field"/\x3e\t\t\t\t\x3c/div\x3e\t\t\t\t\x3cdiv class\x3d"row"\x3e\t\t\t\t\t\x3cdiv kemo-type\x3d"messages" class\x3d"messages-box"\x3e\t\t\t\t\t\t\x3cchat-line each\x3d{messages.items}\x3e\x3c/chat-line\x3e\t\t\t\t\t\x3c/div\x3e\t\t\t\t\x3c/div\x3e\t\t\t\t\x3cdiv class\x3d"row"\x3e\t\t\t\t\t\x3cdiv class\x3d"ten columns"\x3e\t\t\t\t\t\t\x3cinput type\x3d"text" kemo-type\x3d"message" class\x3d"message-box" onkeypress\x3d"{onMessageKeyPress}"/\x3e\t\t\t\t\t\x3c/div\x3e\t\t\t\t\t\x3cdiv class\x3d"two columns"\x3e\t\t\t\t\t\t\x3cbutton class\x3d"send-btn button-primary" kemo-type\x3d"send-btn" onclick\x3d"{onSendMessage}"\x3eSend\x3c/button\x3e\t\t\t\t\t\x3c/div\x3e\t\t\t\t\x3c/div\x3e\t\t\t\x3c/div\x3e',
...
c.page.trigger("messaging-connect",{source:c,key:c.keyInp.value})});var g=function(){var b={source:c,key:c.keyInp.value,message:c.messageInp.value};c.page.trigger("messaging-send",b);c.sentMessages.add(b.message);c.messageInp.value=""};c.onSendMessage=function(b){g()}.bind(this);c.onKeyChanged=function(b){c.page.trigger("ui-key-changed",c.keyInp.value);return!0}.bind(this);c.onMessageKeyPress=function(b){13===(b.which||b.keyCode)&&g();return!0}.bind(this);c.on("ui-received",function(b){var a;a=!1;
...
" (o.o)"));setTimeout(a.tryHide,6E5)});a.tryHide=function(){a.notifCount--;0===a.notifCount&&a.hide()};a.hide=function(){a.titleElem.text.endsWith(" (o.o)")&&(a.titleElem.text=a.titleElem.text.replace(" (o.o)"," (-.-)"))};window.addEventListener("focus",a.hide);window.addEventListener("blur",a.hide);window.addEventListener("message",function(h){"ui-focus"===h.data&&a.hide()},!1);return a};return a}(kemo||{}),kemo=function(a){a.client=a.client||{};var d=a.client.view,h=a.client.comm,c=a.client.ext,
g=function(){window.parent&&window.parent.postMessage("ui-focus","*")};a.core.ready(function(){riot.observable(a.client);var b=d.mountKemoChat("#public-chat",a.client),f=new h.Messaging(b.key),e=new c.TitleNotification;f.connect(b.key,function(){b.trigger("update")});f.onmessage=function(a){b.trigger("ui-received",a)};a.client.on("messaging-send",function(a){f.send(a.key,a.message)});a.client.on("ui-key-changed",function(a){f.connect(a)});a.client.on("messaging-connect",function(a){f.connect(a.key)});
a.client.on("ui-received-new",function(){e.trigger("ui-received-new");window.parent&&window.parent.postMessage("ui-received-new","*")});window.addEventListener("focus",g);window.addEventListener("blur",g);setTimeout(f.connectionCheck,5E3);a.client.chatUi=b;a.client.messaging=f});return a}(kemo||{});
