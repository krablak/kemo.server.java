...
var kemo=function(b){b.core=b.core||{};b.core.ready=function(a){"loading"!=document.readyState?a():document.addEventListener("DOMContentLoaded",a)};return b}(kemo||{}),kemo=function(b){b.client=b.client||{};b.client.ext=b.client.ext||{};b.client.ext.TitleNotification=function(){var a=this;riot.observable(a);a.titleElem=document.getElementsByTagName("title")[0];a.notifCount=0;a.titleElem.text+=" (-.-)";a.on("ui-received-new",function(){a.notifCount++;a.titleElem.text.endsWith(" (o.o)")||(a.titleElem.text=
a.titleElem.text.replace(" (-.-)"," (o.o)"));setTimeout(a.tryHide,6E5)});a.tryHide=function(){a.notifCount--;0===a.notifCount&&a.hide()};a.hide=function(){a.titleElem.text.endsWith(" (o.o)")&&(a.titleElem.text=a.titleElem.text.replace(" (o.o)"," (-.-)"))};window.addEventListener("focus",a.hide);window.addEventListener("blur",a.hide);window.addEventListener("message",function(b){"ui-focus"===b.data&&a.hide()},!1);return a};return b}(kemo||{}),kemo=function(b){b.core=b.core||{};b.core.welcome_page=
b.core.welcome_page||{};var a=b.client.ext;b.core.ready(function(){var b=new a.TitleNotification;window.addEventListener("message",function(a){"ui-received-new"===a.data&&b.trigger("ui-received-new")},!1)});return b}(kemo||{});
