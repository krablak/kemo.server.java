...
var kemo=function(b){b.core=b.core||{};b.core.ready=function(b){"loading"!=document.readyState?b():document.addEventListener("DOMContentLoaded",b)};return b}(kemo||{}),kemo=function(b){b.client=b.client||{};b.client.ext=b.client.ext||{};var c=b.client.ext;c.SystemNotification=function(){riot.observable(this);Notification.requestPermission();this.on("ui-received-new",function(a){a=new Notification("New message!",{body:a.data,icon:"/static/icons/Icon-76@2x.png"});setTimeout(a.close.bind(a),5E3)});return this};
