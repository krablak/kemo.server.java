...
var kemo=function(b){b.core=b.core||{};b.core.ready=function(b){"loading"!=document.readyState?b():document.addEventListener("DOMContentLoaded",b)};return b}(kemo||{}),kemo=function(b){b.client=b.client||{};b.client.ext=b.client.ext||{};var c=b.client.ext;c.SystemNotification=function(){"Notification"in window&&(riot.observable(this),Notification.requestPermission(),this.on("ui-received-new",function(a){a=new Notification("New message!",{body:a.data,icon:"/static/icons/Icon-76@2x.png"});setTimeout(a.close.bind(a),
5E3)}));return this};c.TitleNotification=function(){var a=this;riot.observable(a);a.titleElem=document.getElementsByTagName("title")[0];a.notifCount=0;a.titleElem.text+=" (-.-)";a.on("ui-received-new",function(){a.notifCount++;a.titleElem.text.endsWith(" (o.o)")||(a.titleElem.text=a.titleElem.text.replace(" (-.-)"," (o.o)"));setTimeout(a.tryHide,6E5)});a.tryHide=function(){a.notifCount--;0===a.notifCount&&a.hide()};a.hide=function(){a.titleElem.text.endsWith(" (o.o)")&&(a.titleElem.text=a.titleElem.text.replace(" (o.o)",
" (-.-)"))};window.addEventListener("focus",a.hide);window.addEventListener("blur",a.hide);window.addEventListener("message",function(b){"ui-focus"===b.data&&a.hide()},!1);return a};return b}(kemo||{}),kemo=function(b){b.core=b.core||{};b.core.chat_page=b.core.chat_page||{};var c=b.client.ext;b.core.ready(function(){var a=new c.SystemNotification,b=new c.TitleNotification;window.addEventListener("message",function(c){"ui-received-new"===c.data.code&&(b.trigger("ui-received-new"),a.trigger("ui-received-new",
c.data))},!1);window.onbeforeunload=function(){return"Are you sure you want to leave? All settings and conversation will be lost."}});return b}(kemo||{});
