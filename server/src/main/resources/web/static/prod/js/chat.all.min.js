...
var kemo=function(a){a.core=a.core||{};a.core.ready=function(a){"loading"!=document.readyState?a():document.addEventListener("DOMContentLoaded",a)};a.core.base64_encode=function(a){return window.btoa(unescape(encodeURIComponent(a)))};a.core.base64_decode=function(a){try{return decodeURIComponent(escape(window.atob(a)))}catch(c){for(var b="",d=0;d<a.length;d++){var f=a[d];-1!=="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".indexOf(f)&&(b+=f)}return decodeURIComponent(escape(window.atob(b)))}};
a.core.report_error=function(a){a={details:a};for(var c in navigator)a[c]=navigator[c];c=new XMLHttpRequest;c.open("POST","/error/report-agent",!0);c.setRequestHeader("Content-Type","application/json; charset\x3dUTF-8");c.send(JSON.stringify(a))};return a}(kemo||{}),kemo=function(a){a.client=a.client||{};a.client.ext=a.client.ext||{};var e=a.client.ext;e.SystemNotification=function(){if("Notification"in window){riot.observable(this);var a="Hello! Hey! Hallo! Hullo! Halloo! Hollo! Psst! Dude!".split(" ");
Notification.requestPermission();this.on("ui-received-new",function(b){b=a[Math.floor(Math.random()*a.length)];b=new Notification(b,{body:"New message received",icon:"/static/icons/Icon-76@2x.png"});setTimeout(b.close.bind(b),5E3)})}return this};e.TitleNotification=function(){var a=this;riot.observable(a);a.titleElem=document.getElementsByTagName("title")[0];a.notifCount=0;a.titleElem.text+=" (-.-)";a.on("ui-received-new",function(){a.notifCount++;a.titleElem.text.endsWith(" (o.o)")||(a.titleElem.text=
a.titleElem.text.replace(" (-.-)"," (o.o)"));setTimeout(a.tryHide,6E5)});a.tryHide=function(){a.notifCount--;0===a.notifCount&&a.hide()};a.hide=function(){a.titleElem.text.endsWith(" (o.o)")&&(a.titleElem.text=a.titleElem.text.replace(" (o.o)"," (-.-)"))};window.addEventListener("focus",a.hide);window.addEventListener("blur",a.hide);window.addEventListener("message",function(b){"ui-focus"===b.data&&a.hide()},!1);return a};return a}(kemo||{}),kemo=function(a){a.core=a.core||{};a.core.chat_page=a.core.chat_page||
{};var e=a.client.ext;a.core.ready(function(){var a=new e.SystemNotification,b=new e.TitleNotification;window.addEventListener("message",function(d){"ui-received-new"===d.data.code&&(b.trigger("ui-received-new"),a.trigger("ui-received-new",d.data))},!1);window.onbeforeunload=function(){return"Are you sure you want to leave? All settings and conversation will be lost."}});return a}(kemo||{});
