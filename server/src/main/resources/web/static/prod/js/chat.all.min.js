...
var kemo=function(a){a.core=a.core||{};a.core.ready=function(a){"loading"!=document.readyState?a():document.addEventListener("DOMContentLoaded",a)};return a}(kemo||{}),kemo=function(a){a.client=a.client||{};a.client.ext=a.client.ext||{};var b=a.client.ext;b.SystemNotification=function(){if("Notification"in window){riot.observable(this);var c="Hello! Hey! Hallo! Hullo! Halloo! Hollo! Psst! Dude!".split(" ");Notification.requestPermission();this.on("ui-received-new",function(a){a=c[Math.floor(Math.random()*
c.length)];a=new Notification(a,{body:"New message received",icon:"/static/icons/Icon-76@2x.png"});setTimeout(a.close.bind(a),5E3)})}return this};b.TitleNotification=function(){var a=this;riot.observable(a);a.titleElem=document.getElementsByTagName("title")[0];a.notifCount=0;a.titleElem.text+=" (-.-)";a.on("ui-received-new",function(){a.notifCount++;a.titleElem.text.endsWith(" (o.o)")||(a.titleElem.text=a.titleElem.text.replace(" (-.-)"," (o.o)"));setTimeout(a.tryHide,6E5)});a.tryHide=function(){a.notifCount--;
0===a.notifCount&&a.hide()};a.hide=function(){a.titleElem.text.endsWith(" (o.o)")&&(a.titleElem.text=a.titleElem.text.replace(" (o.o)"," (-.-)"))};window.addEventListener("focus",a.hide);window.addEventListener("blur",a.hide);window.addEventListener("message",function(b){"ui-focus"===b.data&&a.hide()},!1);return a};return a}(kemo||{}),kemo=function(a){a.core=a.core||{};a.core.chat_page=a.core.chat_page||{};var b=a.client.ext;a.core.ready(function(){var a=new b.SystemNotification,d=new b.TitleNotification;
window.addEventListener("message",function(b){"ui-received-new"===b.data.code&&(d.trigger("ui-received-new"),a.trigger("ui-received-new",b.data))},!1);window.onbeforeunload=function(){return"Are you sure you want to leave? All settings and conversation will be lost."}});return a}(kemo||{});
